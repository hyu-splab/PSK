file://<WORKSPACE>/examples/src/main/java/kafka/examples/Consumer.java
...
action parameters:
uri: file://<WORKSPACE>/examples/src/main/java/kafka/examples/Consumer.java
text:
```scala
/*
...
public class Consumer extends Thread implements ConsumerRebalanceListener {
 ...
 RecordDeserializationException e) {
    ...
    public KafkaConsumer<Integer, String> createKafkaConsumer() {
        ...
        //String ClientId = "my_first_client";
