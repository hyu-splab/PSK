...
public class RemoteLogSegmentMetadataUpdateRecordJsonConverter {
    public static RemoteLogSegmentMetadataUpdateRecord read(JsonNode _node, short _version) {
        ...
        if (_customMetadataNode == null) {
            throw new RuntimeException("RemoteLogSegmentMetadataUpdateRecord: unable to locate field 'customMetadata', which is mandatory in version " + _version);
        } else {
            if (_customMetadataNode.isNull()) {
                _object.customMetadata = null;
            } else {
                _object.customMetadata = MessageUtil.jsonNodeToBinary(_customMetadataNode, "RemoteLogSegmentMetadataUpdateRecord");
            }
        }
    ...
    public static JsonNode write(RemoteLogSegmentMetadataUpdateRecord _object, short _version, boolean _serializeRecords) {
        ...
        if (_object.customMetadata == null) {
            _node.set("customMetadata", NullNode.instance);
        } else {
            _node.set("customMetadata", new BinaryNode(Arrays.copyOf(_object.customMetadata, _object.customMetadata.length)));
        }
