...
public class RemoteLogSegmentMetadataRecordJsonConverter {
    public static RemoteLogSegmentMetadataRecord read(JsonNode _node, short _version) {
        ...
        if (_customMetadataNode == null) {
            throw new RuntimeException("RemoteLogSegmentMetadataRecord: unable to locate field 'customMetadata', which is mandatory in version " + _version);
        } else {
            if (_customMetadataNode.isNull()) {
                _object.customMetadata = null;
            } else {
                _object.customMetadata = MessageUtil.jsonNodeToBinary(_customMetadataNode, "RemoteLogSegmentMetadataRecord");
            }
        }
