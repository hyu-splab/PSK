...
public class KafkaChannel implements AutoCloseable {
    ...
    //03/20code
    //04/02code
    public boolean setFlag(int flag){ //0이외의 값으로 설정 될 것. 
        this.flag = flag;
    ...
    public long write() throws IOException {
        ...
        // System.out.println("KafkaChannel id is : "+id);
        /*
          System.out.println("KafkaChannel socket check : Address => "
             +transportLayer.socketChannel().socket().getLocalAddress().getHostAddress()+", Port => "
             + transportLayer.socketChannel().socket().getLocalPort());
        */
        //System.out.println(metadataRegistry.toString());
